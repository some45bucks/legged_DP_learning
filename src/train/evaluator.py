...
class evaluator:
  ...
  def __init__(self, eval_env: envs.Env,  ppo_network: ppo_network, norm, num_eval_envs: int, episode_length: int, action_repeat: int, key: PRNGKey):
    self._key = key
    ...
    def generate_eval_unroll(normalizer_params: Any, params: Any, key: PRNGKey) -> envs.State:
      ...
      return unroll_policy(
        ...
        key,
        eval_env,
        episode_length // action_repeat)[0]
